...
// let currentPage = 1; // Додав нову глобальну змінну для відстеження поточної сторінки
// let searchTerm = ''; // Додав нову глобальну змінну для збереження введеного пошукового терміну
// const perPage = 40;
